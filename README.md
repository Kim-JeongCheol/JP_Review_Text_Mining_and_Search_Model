...
> WordCloud 결과, **‘회사’, ‘사람’, ‘업무’, ‘개발’, ‘연봉’, ‘환경’, ‘워라벨’, ‘복지’** 등의 단어가  
> 상대적으로 크게 나타났으며, 이들이 리뷰 제목에서 **자주 언급된 주요 키워드**임을 확인할 수 있다.  
>
> 그 외에도 **‘경험’, ‘성장’, ‘분위기’, ‘시간’, ‘프로젝트’, ‘직장’, ‘개발자’, ‘팀’** 등의 단어가 다수 등장하였다.  
>
> 전반적으로 다양한 단어가 분포하였으며, 특정 소수 키워드에 편중되지 않은  
> 비교적 고른 빈도 분포를 보였다. 
